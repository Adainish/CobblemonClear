package io.github.adainish.cobblemonclear.command;
    ...
    public static LiteralArgumentBuilder<CommandSourceStack> getCommand() {
        return Commands.literal("cobbleclear")
                ...
                .then(Commands.literal("reload")
                        .executes(cc -> {
                            //do reload
                            CobblemonClear.instance.reload();
                ...
                .then(Commands.literal("items")
                        .executes(cc -> {
                            ...
                            CobblemonClear.manager.itemWiper.wipe();
                            return 1;
                        })
                )
                .then(Commands.literal("pokemon")
                        .executes(cc -> {
                            ...
                            CobblemonClear.manager.pokemonWiper.wipe();
                            return 1;
                        })
                )
                                    ...
                                    try {
                                        ...
                                        if (location != null) {
                                            ...
                                            if (!CobblemonClear.config.itemWhitelist.isWhiteListed(location.toString())) {
                                                //whitelist item
                                                Config config = CobblemonClear.config;
                        ...
                        .then(Commands.literal("species")
                                ...
                                .then(Commands.argument("speciesname", StringArgumentType.string())
                                        .executes(cc -> {
                                            ...
                                            //check valid species
                                            if (Util.getSpeciesFromString(speciesName) != null)
                                            {
                                                if (!CobblemonClear.config.pokemonWhitelist.isWhiteListed(speciesName))
                                                {
                                                    Config config = CobblemonClear.config;
